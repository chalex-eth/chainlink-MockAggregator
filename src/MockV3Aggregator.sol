...
import {DataFetcher} from "./DataFetcher.sol";
 ...
 */
contract MockV3Aggregator is DataFetcher {
    ...
    constructor(
        ...
        DataFetcher(pathToRequestJS, assetToFecth)
    {
        decimals = _decimals;
        updateAnswer();
    }
    ...
    function updateAnswer() public {
        latestAnswer = int256(data[latestRound]);
